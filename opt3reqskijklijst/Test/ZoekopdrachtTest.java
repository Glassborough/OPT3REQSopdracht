...
public class ZoekopdrachtTest {
    ...
    Titel breakingBad = new Serie("Breaking Bad", netflix, 8);
    // maak nieuwe titel aan met letter B die op videoland staat
    Titel batmanBegins = new Film("Batman Begins", videoland);
    // maak nieuwe titel aan met letter B die op prime staat
    Titel babyDriver = new Film("Baby Driver", amazonPrime);
